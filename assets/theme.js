...
/******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_VariantSelector__ = __webpack_require__(
        16
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helper_Currency__ = __webpack_require__(
        5
      );
      /**
        ...
        _createClass(ProductVariants, [
          ...
          },
          {
            ...
            value: function _createSelectors() {
              ...
              __WEBPACK_IMPORTED_MODULE_1__helper_Dom__['default']
                ...
                .forEach(function(item) {
                  var variantSelector = new __WEBPACK_IMPORTED_MODULE_2__components_VariantSelector__[
                    'default'
                  ](item, {
                    onValueChanged: _this6._onOptionChanged.bind(_this6)
                  });
          ...
          },
          {
            ...
            value: function _onOptionChanged(newValue, target, activator) {
              ...
              var selectedValueElement = activator.querySelector(
                  '.ProductForm__SelectedValue'
                ),
                colorSwatchElement = activator.querySelector(
              ...
              if (colorSwatchElement) {
                ...
                if (
                  ...
                  colorSwatchElement.style.backgroundColor = target.getAttribute(
                ...
                colorSwatchElement.style.backgroundImage =
                  'url(' + target.getAttribute('data-background-image') + ')';

                if (newValue.toLowerCase() === 'white') {
                  colorSwatchElement.classList.add(
                    'ProductForm__ColorSwatch--white'
                  );
                } else {
                  colorSwatchElement.classList.remove(
                    'ProductForm__ColorSwatch--white'
                  );
                }
              }
                    ...
                    case 'select':
                      switch (formElement.type) {
                        ...
                        case 'select-multiple':
                          for (
                            j = 0, jLen = formElement.options.length;
                            j < jLen;
                            j++
                          ) {
        ...
        _createClass(ProductImageZoom, [
          ...
          },
          {
            ...
            value: function _onDoubleTap(point) {
              var initialZoomLevel = this.photoSwipeInstance.currItem
                .initialZoomLevel;
        ...
        _createClass(VariantSelector, [
          ...
          },
          {
            ...
            value: function _onVariantSelect() {
              var selectedCell = this.variantCarousel.flickityInstance
        ...
        _createClass(ShippingEstimator, [
          ...
          },
          {
            ...
            value: function _fetchRates() {
              ...
              var country = this.element.querySelector('[name="country"]')
                  .value,
                province = this.element.querySelector('[name="province"]')
                  .value,
              ...
              Promise.all(queries).then(function(responses) {
                ...
                Promise.all(
                  ...
                  if (window.theme.searchMode === 'product') {
                    ...
                    _this18.searchResultsElement.innerHTML =
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Search__ = __webpack_require__(
        23
      );
      /* harmony reexport (binding) */ __webpack_require__.d(
        __webpack_exports__,
            ...
            value: function _checkToolbarVisibility() {
              ...
              fastdom.measure(function() {
                ...
                if (_this24.articleNavElement) {
                  navBottom =
                    _this24.articleNavElement.offsetTop +
                    _this24.articleNavElement.clientHeight -
                    headerHeight;
                }
              });

              fastdom.mutate(function() {
                _this24.toolbarElement.style.top = isFixedHeader
                  ? headerHeight + 'px'
                  : null;
        ...
        _createClass(BackgroundVideoSection, [
          {
            ...
            value: function _loadScript() {
              ...
              return new Promise(function(resolve, reject) {
                ...
                script.async = true;
                script.src =
                  _this26.options['videoType'] === 'youtube'
            ...
            value: function _setupPlayer() {
              ...
              setTimeout(function() {
                if (_this27.options['videoType'] === 'youtube') {
                  ...
                  _this27.player = new Vimeo.Player(
        ...
        _createClass(CartSection, [
            ...
            value: function _rerenderCart(elementToAnimate) {
              ...
              return fetch(
                ...
                if (_this31.options['drawer'] && elementToAnimate) {
                  ...
                  if (_this31.itemCount === 0) {
                    timelineLite.to(
                      _this31.element.querySelector('.Drawer__Footer'),
                      0.5,
          ...
          },
          {
            ...
            value: function _replaceContent(html) {
              ...
              var cartNodeParent = this.element.querySelector('.Cart')
                .parentNode;
        ...
        _createClass(CollectionSection, [
          ...
          },
          {
            ...
            value: function _changeLayoutMode(event, target) {
              ...
              formData.append(
                'attributes[collection_' + layoutType + '_items_per_row]',
                newCount
              );
            ...
            value: function _updateActiveTags() {
              ...
              __WEBPACK_IMPORTED_MODULE_3__helper_Dom__['default']
                ...
                .forEach(function(item) {
                  ...
                  if (
                    _this35.temporaryTags.includes(
              ...
              __WEBPACK_IMPORTED_MODULE_3__helper_Dom__['default']
                ...
                .forEach(function(resetButton) {
                  resetButton.style.display =
                    _this36.currentTags.length === 0 ? 'none' : 'block';
                });
            }
          },
          {
            ...
            value: function _reloadProducts() {
              ...
              fetch(
                ...
                response.text().then(function(content) {
                  ...
                  _this37.collectionInnerElement.innerHTML = tempElement.querySelector(
                    '.shopify-section'
                  ).innerHTML;
                  document.dispatchEvent(new CustomEvent('theme:loading:end'));
                  ...
                  if (
                    ...
                    _this37.toolbarElement &&
                    _this37.toolbarElement.clientHeight === 0
                  ) {
                    elementOffset -= 50;
                  }
            ...
            mainLogo.addEventListener('load', function() {
              fastdom.measure(function() {
                document.documentElement.style.setProperty(
                  '--header-height',
                  _this42.element.clientHeight + 'px'
                );
                document.documentElement.style.setProperty(
                  '--header-is-not-transparent',
                  _this42.options['hasTransparentHeader'] ? 0 : 1
                );
              });
            });
          } else {
        ...
        _createClass(HeaderSection, [
          ...
          },
          {
            ...
            value: function _closeNavigation() {
              ...
              fastdom.mutate(function() {
                __WEBPACK_IMPORTED_MODULE_0__helper_Dom__['default']
                  .nodeListToArray(
                    _this45.element.querySelectorAll('.is-expanded')
                  )
                  .forEach(function(item) {
                    item.classList.remove('is-expanded');
                  });
                ...
                __WEBPACK_IMPORTED_MODULE_0__helper_Dom__['default']
                  .nodeListToArray(
                    _this45.element.querySelectorAll('[aria-hidden="false"]')
                  )
                  .forEach(function(item) {
                    item.setAttribute('aria-hidden', 'true');
                  });
              ...
              fastdom.mutate(function() {
                ...
                __WEBPACK_IMPORTED_MODULE_0__helper_Dom__['default']
                  ...
                  .forEach(function(item) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0__helper_Dom__['default']
                      .nodeListToArray(item.children, '[aria-hidden="false"]')
                      .forEach(function(item) {
                        item.setAttribute('aria-hidden', 'true');
                      });
                  });
            ...
            value: function _checkNavigationBounds() {
              ...
              fastdom.measure(function() {
                ...
                __WEBPACK_IMPORTED_MODULE_0__helper_Dom__['default']
                  ...
                  .forEach(function(item) {
                    _this46.mainMenuWidth += parseInt(
                      __WEBPACK_IMPORTED_MODULE_0__helper_Dom__[
                        'default'
                      ].outerWidthWithMargin(item)
                    );
                  });
              });
          ...
          },
          {
            ...
            value: function _verifyNavigationOverlap() {
              ...
              fastdom.measure(function() {
                isOverlapping =
                  _this47.mainMenuWidth >
                  Math.ceil(
                    _this47.element.querySelector('.Header__Logo').offsetLeft -
                      _this47.menuLeftOffset
                  );
              });
            ...
            value: function _initFeed() {
              ...
              if (!this.instafeed.hasAttribute('data-access-token')) {
                ...
                var instafeed = new Instafeed({
                  ...
                  template:
                    '<a href="{{link}}" target="_blank" class="Carousel__Cell Instafeed__Cell">' +
                    '<div rel="noopener" class="Instafeed__Image Image--lazyLoad Image--zoomOut" data-expand="10" data-bg="{{image}}" aria-label="Open on Instagram"></div>' +
            ...
            value: function _updateSlideshowImage(event) {
              ...
              if (
                ...
                for (
                  ...
                  var cellElement = this.productSlideshow.flickityInstance
                      .cells[i].element,
                    imageId = parseInt(
          ...
          },
          {
            ...
            value: function _checkQuickNav() {
              ...
              fastdom.measure(function() {
                showAsideQuickNav =
                  window.scrollY >=
                  _this52.productAsideElement.offsetTop -
                    _this52.productAsideElement.clientHeight;
              });
            ...
            value: function _setupDeviceFeatures(event) {
              ...
              if (
                ...
                if (this.slideshowImages && this.slideshowImages.length > 1) {
                  var offsetTop = this.slideshowNavDots.firstElementChild
                    .offsetTop;
                ...
                var calculateMinHeight = function calculateMinHeight() {
                  if (_this53.productAsideElement) {
                    _this53.productAsideElement.style.minHeight =
                      _this53.productInfoElement.scrollHeight -
                      productInfoPadding +
                      'px';
                    _this53.productInfoElement.closest(
                    ...
                    _this53.productWrapperElement.style.minHeight =
                      _this53.productInfoElement.scrollHeight -
                      parseInt(productInfoStyles.paddingTop) +
                      'px';
                  }
            ...
            value: function _fetchProducts() {
              ...
              fetch(
                ...
                response.text().then(function(content) {
                  ...
                  // Set the content
                  _this54.element.innerHTML = tempElement.querySelector(
                    '.Section'
                  ).innerHTML;
                  ...
                  _this54.carousel = new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__[
                    'default'
                  ](_this54.element.querySelector('[data-flickity-config]'));
                });
              });
            }
          },
            ...
            value: function _createOuterCarousel() {
              ...
              __WEBPACK_IMPORTED_MODULE_2__helper_Dom__['default']
                ...
                .forEach(function(item) {
                  ...
                  _this59.innerCarousels[lookIndex].push(
                    new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__[
                      'default'
                    ](item, {
          ...
          },
          {
            ...
            value: function _openPocketZoom(popover) {
              ...
              fastdom.mutate(function() {
                ...
                _this60.outerCarousel.flickityInstance.element.classList.add(
                  'is-zoomed'
                );
                _this60.outerCarousel
                  .getSelectedCell()
            ...
            value: function _calculateImageTransform(openPopover) {
              ...
              fastdom.measure(function() {
                ...
                _this61._calculateTransformForDotListener = function(event) {
                  ...
                  fastdom.mutate(function() {
                    _this61.outerCarousel.flickityInstance.viewport.style.transform =
                      'translate3d(0, ' +
                ...
                selectedCell.addEventListener(
                  'product:changed',
                  _this61._calculateTransformForDotListener
                );
          ...
          },
          {
            ...
            value: function _closePocketZoom() {
              ...
              fastdom.mutate(function() {
                ...
                _this62.outerCarousel.flickityInstance.element.classList.remove(
                  'is-zoomed'
                );
                ...
                .forEach(function(image) {
                  if (
                    ...
                    image.addEventListener(
                      'lazyloaded',
                      _this63._slideEnter.bind(_this63, slide)
                    );
                  } else {
          ...
          },
          {
            ...
            value: function _lazyLoadNextImage() {
              ...
              if (
                ...
                var nextCellElement = this.slideshow.flickityInstance.cells[
                    currentIndex + 1
                  ].element,
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ProductSection__ = __webpack_require__(
        42
      );
      /* harmony reexport (binding) */ __webpack_require__.d(
        __webpack_exports__,
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__RecentlyViewedProductsSection__ = __webpack_require__(
        43
      );
      /* harmony reexport (binding) */ __webpack_require__.d(
        __webpack_exports__,
        ...
        function() {
          return __WEBPACK_IMPORTED_MODULE_18__RecentlyViewedProductsSection__[
            'default'
          ];
        }
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__RelatedProductsSection__ = __webpack_require__(
        44
      );
      /* harmony reexport (binding) */ __webpack_require__.d(
        __webpack_exports__,
        ...
        function() {
          return __WEBPACK_IMPORTED_MODULE_19__RelatedProductsSection__[
            'default'
          ];
        }
      );
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      (function() {
        ...
        sections.register(
          'related-products',
          __WEBPACK_IMPORTED_MODULE_2__sections__['RelatedProductsSection']
        );
